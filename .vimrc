" vim-bootstrap 2026-04-03 16:43:51
...
" terminal emulation
nnoremap <silent> <leader>sh :bel terminal ++rows=16<CR>
...
nnoremap <silent> <leader>f :call fzf#run(fzf#wrap('FZF', {'options': ['-m', '--preview', 'bat --style=numbers --color=always {}']}, 0))<CR>
